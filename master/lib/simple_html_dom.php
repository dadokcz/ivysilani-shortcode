...
function ivysilani_file_get_html(
    $url,
    ...
    $defaultSpanText = DEFAULT_SPAN_TEXT)
{
    ...
    $dom = new ivysilani_simple_html_dom(
        null,
        $lowercase,
        $forceTagsClosed,
        $target_charset,
...
function ivysilani_str_get_html(
    $str,
    $lowercase = true,
    $forceTagsClosed = true,
    $target_charset = DEFAULT_TARGET_CHARSET,
...
function ivysilani_dump_html_tree($node, $show_attr = true, $deep = 0)
{
    $node->dump($node);
}

class ivysilani_simple_html_dom_node
{
...
class ivysilani_simple_html_dom
{
    public $root = null;
    public $nodes = array();
        ...
        $defaultSpanText = DEFAULT_SPAN_TEXT)
    {
        ...
        $this->root = new ivysilani_simple_html_dom_node($this);
        $this->root->tag = 'root';
    ...
    protected function parse()
    {
        while (true) {
            ...
            $node = new ivysilani_simple_html_dom_node($this);
            ++$this->cursor;
